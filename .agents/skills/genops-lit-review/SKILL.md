...
First stage in the Research pipeline. No upstream dependencies. Generates systematic literature reviews into `docs/lit-review/`.
...
**Config:** `id: lit-review`, `requires: []`, `outputs: docs/lit-review/`, `file_pattern: LIT-REVIEW-{NNN}-{slug}.md`, `template: research/LIT-REVIEW.md.template`, `next: [hypothesis]`
...
4. **CHECK** — First stage. Check for existing `docs/lit-review/LIT-REVIEW-*.md`.
...
6. **GENERATE** — Generate `docs/lit-review/LIT-REVIEW-{NNN}-{slug}.md` with prior art matrix and identified research gaps.
